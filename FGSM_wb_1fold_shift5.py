from arml.exp import exp_fgsm_impact_wb_1fold_shift5
...
# name for the logger     
logger_name = 'vtcnn2_FGSM_wb_1fold_shift5'
# output path
output_path = 'outputs/vtcnn2_FGSM_wb_1fold_shift5_op.pkl'  
exp_fgsm_impact_wb_1fold_shift5(file_path=file_path,
                n_runs=n_runs, 
                verbose=verbose, 
                # scenario=scenario,
                epsilons=epsilons, 
