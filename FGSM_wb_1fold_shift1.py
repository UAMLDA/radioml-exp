from arml.exp import exp_fgsm_impact_wb_1fold_shift1
...
train_params = {'type': 'vtcnn2', 
                ...
                'NHWC': [220000, 2, 128, 1],
                'tpu': False, 
                'file_path': 'FGSM_CNN2_1fold_shift1.wts.h5'}
# name for the logger     
logger_name = 'vtcnn2_FGSM_wb_1fold_shift1'
# output path
output_path = 'outputs/vtcnn2_FGSM_wb_1fold_shift1_op.pkl'  
exp_fgsm_impact_wb_1fold_shift1(file_path=file_path,
                n_runs=n_runs, 
                verbose=verbose, 
                # scenario=scenario,
                epsilons=epsilons, 
