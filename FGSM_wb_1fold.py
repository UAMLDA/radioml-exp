from arml.exp import exp_fgsm_impact_wb_1fold
...
# name for the logger     
logger_name = 'vtcnn2_FGSM_wb_1fold'
# output path
output_path = 'outputs/vtcnn2_FGSM_wb_1fold_op.pkl'  
exp_fgsm_impact_wb_1fold(file_path=file_path,
                n_runs=n_runs, 
                verbose=verbose, 
                # scenario=scenario,
                epsilons=epsilons, 
